...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "descOn2": MessageLookupByLibrary.simpleMessage(
      "توقف عن انتظار اللحظة المثالية. ابدأ رحلتك الآن وغير حياتك!",
    ),
    "descOn3": MessageLookupByLibrary.simpleMessage(
      "بالتفاني والعقلية الصحيحة، يمكنك تحقيق أهداف لياقتك البدنية وبناء شخص أفضل!",
    ),
